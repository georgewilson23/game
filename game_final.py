...
def tick(keys):
    ...
    if state == 'game':
        ...
        if counter <= 20:
            camera.draw(gamebox.from_text(300,150,'3','arial',30,'purple'))
        if counter <= 40 and counter > 20:
            camera.draw(gamebox.from_text(300,150,'2','arial',30,'purple'))
        if counter <= 60 and counter > 40:
            camera.draw(gamebox.from_text(300,150,'1','arial',30,'purple'))


        if counter >= 60 and ball.yspeed < 30:
            ball.yspeed += 1
        if counter >= 60:
            ball.y = ball.y + ball.yspeed

        camera.draw(gamebox.from_text(75,20,'Points: '+str(points),'arial', 30,'purple'))
        camera.draw(gamebox.from_text(250,20,'High Score: '+str(highscore),'arial',30,'purple'))
        ...
        if counter % 15 == 0:
            ...
            if choose == 1:
                ...
                new_wall = gamebox.from_color(xval, 800,color, 150,height)
                new_wall2 = gamebox.from_color(xval-250, 800,color, 150,height)
                new_wall3 = gamebox.from_color(xval+250, 800,color, 150,height)
            ...
            if choose == 2:
                color = colors[random.randint(0,len(colors)-1)]
                xval = random.randint(200,400)
                new_wall = gamebox.from_color(xval, 800,color, 250,height)
                new_wall2 = gamebox.from_color(xval-275, 800,color, 150,height)
                new_wall3 = gamebox.from_color(xval+275, 800,color, 150,height)
                walls.append(new_wall)
                walls.append(new_wall2)
                walls.append(new_wall3)
            if choose == 3:
                color = colors[random.randint(0,len(colors)-1)]
                xval = random.randint(200,400)
                new_wall = gamebox.from_color(xval, 800,color, 300,height)
                new_wall2 = gamebox.from_color(xval-275, 800,color, 80,height)
                new_wall3 = gamebox.from_color(xval+300, 800,color, 150,height)
                walls.append(new_wall)
                walls.append(new_wall2)
                walls.append(new_wall3)
            if choose == 4:
                color = colors[random.randint(0,len(colors)-1)]
                xval = random.randint(100,500)
                new_wall = gamebox.from_color(xval, 800,color, 150,height)
                new_wall2 = gamebox.from_color(xval-190, 800,color, 80,height)
                new_wall3 = gamebox.from_color(xval+190, 800,color, 80,height)
                new_wall4 = gamebox.from_color(xval+400, 800,color, 100,height)
                new_wall5 = gamebox.from_color(xval-300, 800,color, 150,height)
                walls.append(new_wall)
                walls.append(new_wall2)
                walls.append(new_wall3)
            ...
            if choose2 == 4:
                xval = random.randint(150,450)
                bomb = gamebox.from_image(xval,980,'bomb-33px.png')
        ...
        # if pygame.K_h in keys:                #for testing
        #     walls = []
        #     powerup_clear = []
        #     powerup_speed = []
        #     powerup_wrap = []
    ...
    if state == 'end':
        ...
        camera.draw(gamebox.from_text(100,20,'High Score: '+str(highscore),'arial',30,'purple'))
        camera.display()
        if pygame.K_SPACE in keys:
            walls = []
            timer = 0
